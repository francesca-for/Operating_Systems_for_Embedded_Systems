...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file ex1.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/goil/templates ex1.oil")
	sys.exit(1)
...
oilCompiler = "goil"
oilFlags = ["-t=avr/arduino/uno", "--templates=/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/goil/templates"]
...
#--- Add generated files
sourceList.append("ex1/tpl_app_config.c")

sourceList.append("ex1/tpl_dispatch_table.c")
sourceList.append("ex1/tpl_invoque.S")
sourceList.append("ex1/tpl_interrupts.c")
