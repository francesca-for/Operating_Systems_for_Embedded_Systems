...
sys.path.append("/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/make")
...
includeDirs += ["-I","/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr/arduino/"]
includeDirs += ["-I","/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr"]
includeDirs += ["-I","/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr/arduino/cores/arduino"]
if with_ioc:
  includeDirs += ["-I", "/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/ioc"]
includeDirs += ["-I", "/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/com"]
includeDirs += ["-I", "/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/os"]
includeDirs += ["-I", "/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/debug"]
includeDirs += ["-I", "ex2"]
cflags   += includeDirs
...
cSourceList.append(projfile.ProjectFile("ex2.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("ex2/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ex2/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("ex2/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("ex2/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary lab01ex2.hex from lab01ex2")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("lab01ex2")
  postCommand.mCommand.append("lab01ex2.hex")
...
postVariableMapping = dict(
  MACHINE_PATH='/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines',
  ARCH_PATH='/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr',
  BOARD_PATH='/Users/francescafornasier/github/Operating_Systems_for_Embedded_Systems/trampoline/machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing lab01ex2 on avr/arduino/uno\033[0m")
